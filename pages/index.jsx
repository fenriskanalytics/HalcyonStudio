    ...
    <div style={{ width: "100%", padding: "100px", alignContent: "center" }}>
      <header>
        ...
        <h4>
          ...
          <h3>Your pages:</h3>
          <ul>
            <li><Link href="/home">Homepage - /home</Link></li>
<li><Link href="/new-page">RegistrationPage - /new-page</Link></li>
<li><Link href="/new-page-2">UserInfoPage - /new-page-2</Link></li>
<li><Link href="/Announcements">NewsletterRegistration - /Announcements</Link></li>
<li><Link href="/cookies-policy">CookiesPolicy - /cookies-policy</Link></li>
<li><Link href="/privacy-policy">PrivacyPolicy - /privacy-policy</Link></li>
<li><Link href="/memberships">Memberships - /memberships</Link></li>
<li><Link href="/events">Events - /events</Link></li>
<li><Link href="/about-us">AboutUs - /about-us</Link></li>
<li><Link href="/contact">Contact - /contact</Link></li>
<li><Link href="/terms-of-service">TermsOfService - /terms-of-service</Link></li>
<li><Link href="/account">Account - /account</Link></li>
<li><Link href="/buy">Buy - /buy</Link></li>
<li><Link href="/schedule">Schedule - /schedule</Link></li>
          </ul>
