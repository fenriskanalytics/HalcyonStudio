...
import sty from "./PlasmicAlert.module.css"; // plasmic-import: zLDzQ49_JXqf/css
import Icon11Icon from "./icons/PlasmicIcon__Icon11"; // plasmic-import: yKGpUY2EOId4/icon
  ...
  return (
    ...
    >
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__mcke, {
          [sty.freeBoxnoBody__mckebvv4T]: hasVariant(
            $state,
            "noBody",
            "noBody"
          ),
          [sty.freeBoxnoHeader__mckeQnGrv]: hasVariant(
            $state,
            "noHeader",
            "noHeader"
          ),
          [sty.freeBoxnoIcon__mckehkkvB]: hasVariant($state, "noIcon", "noIcon")
        })}
      >
        <div
          className={classNames(projectcss.all, sty.freeBox__x9Zdq, {
            [sty.freeBoxnoIcon__x9ZdqhkkvB]: hasVariant(
              $state,
              "noIcon",
              "noIcon"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <Icon11Icon
                className={classNames(projectcss.all, sty.svg__lfvq)}
                role={"img"}
              />
            ),
        ...
        <Stack__
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__mZ8Wn, {
            [sty.freeBoxnoHeader__mZ8WnQnGrv]: hasVariant(
              $state,
              "noHeader",
              "noHeader"
            ),
            [sty.freeBoxnoIcon__mZ8WnhkkvB]: hasVariant(
              $state,
              "noIcon",
              "noIcon"
            )
        ...
        >
          ...
          >
            {renderPlasmicSlot({
              defaultContents: <Trans__>{"Heads up!"}</Trans__>,
              value: args.header
            })}
          </h6>
          <div
            className={classNames(projectcss.all, sty.freeBox___75Ld8, {
              [sty.freeBoxnoBody___75Ld8Bvv4T]: hasVariant(
                $state,
                "noBody",
                "noBody"
              ),
              [sty.freeBoxnoHeader___75Ld8QnGrv]: hasVariant(
                $state,
                "noHeader",
                "noHeader"
              )
