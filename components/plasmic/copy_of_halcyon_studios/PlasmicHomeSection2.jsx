...
import sty from "./PlasmicHomeSection2.module.css"; // plasmic-import: M0IYPZJH3OXM/css

createPlasmicElementProxy;

export const PlasmicHomeSection2__VariantProps = new Array("blurVariant");

export const PlasmicHomeSection2__ArgProps = new Array("hrefRedirect");
...
function PlasmicHomeSection2__RenderFunc(props) {
...
function makeNodeComponent(nodeName) {
    ...
    const { variants, args, overrides } = React.useMemo(
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames: PlasmicHomeSection2__ArgProps,
          internalVariantPropNames: PlasmicHomeSection2__VariantProps
        }),
      [props, nodeName]
    );
    return PlasmicHomeSection2__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "root") {
    func.displayName = "PlasmicHomeSection2";
  } else {
    func.displayName = `PlasmicHomeSection2.${nodeName}`;
  }
  return func;
}

export const PlasmicHomeSection2 = Object.assign(
  // Top-level PlasmicHomeSection2 renders the root element
  makeNodeComponent("root"),
  {
    ...
    // Metadata about props expected for PlasmicHomeSection2
    internalVariantProps: PlasmicHomeSection2__VariantProps,
    internalArgProps: PlasmicHomeSection2__ArgProps
  }
);

export default PlasmicHomeSection2;
/* prettier-ignore-end */
